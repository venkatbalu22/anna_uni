...
<head>
  ...
  <!-- Title -->
  <!-- --------------------------------------------------- -->
  <title> Dean |Employee List</title>
        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
          <div class="card-body px-4 py-3">
            <div class="row align-items-center">
              <div class="col-9">
                <h4 class="fw-semibold mb-8">Empolyee List</h4>
        ...
        <section>
          <div class="card card-body">
            <div class="table-responsive">
              <table class="table search-table align-middle text-nowrap" id="emp_table">
          ...
          <script>
            function fetchdata() {
              $.ajax({
                url: '../ajax/admin/employee_list.php',
                method: 'get',
