              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      ...
                      <div class="form-floating mb-3">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="name" placeholder="Enter Name here" fdprocessedid="duxyzp" data-ddg-inputtype="identities.fullName">
                            <label for="tb-fname">Employee Name</label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-floating mb-3">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="Mnumber" placeholder="Enter Name here" oninput="allowOnlyNumbers(this);" fdprocessedid="duxyzp" data-ddg-inputtype="identities.fullName">
                            <label for="tb-fname">Mobile Number</label>
                        </div>
                      </div>
                      <!-- <label for="tb-num"> Mobile Number </label> -->
                      <!-- <div class="form-floating mb-3"> -->
                      <!-- <input type="text" class="form-control" id="Mnumber" placeholder="Mobile Number" oninput="allowOnlyNumbers(this);" fdprocessedid="duxyzp" data-ddg-inputtype="identities.mobilenumber"> -->
                        <!-- <input type="text" class="form-control"  placeholder="Mobile Number" id="Mnumber" oninput="allowOnlyNumbers(this)"/> -->
                      <!-- </div> -->
                    </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-floating mb-3">
                        <input type="password" class="form-control" id="pwd" placeholder="Password" oninput="password();">
                    ...
                    <div class="col-md-4">
                      <div class="form-floating">
                        <input type="password" class="form-control" id="cpwd" placeholder="Password" oninput="password();" />
                        <label for="tb-cpwd">Confirm Password</label>
                      </div>
                      <p id="note" style="font-size: 11px;"></p>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="d-md-flex align-items-center mt-3">
                      ...
                      <div class="ms-auto mt-3 mt-md-0">
                        <button id="create" class="btn btn-success font-medium rounded-pill px-4">Create Employee
                      </div>
                      </button>
                    </div>
                  </div>
    ...
    $(document).ready(function () {
      $('#create').click(function () {
        ...
        if (name == '') {
          ...
          $.ajax({
            url: '../ajax/admin/employee_creation.php',
            method: 'post',
            contentType: false,
            processData: false,
            data: fd,
