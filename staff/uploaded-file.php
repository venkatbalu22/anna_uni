        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
          <div class="card-body px-4 py-3">
            <div class="row align-items-center">
              <div class="col-9">
                <h4 class="fw-semibold mb-8">Uploaded File</h4>
        ...
        <div class="card card-body">
          <div class="row">
            ...
            <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
              ...
              <a href="fileupload.php" id="btn-add-contact" class="btn btn-info d-flex align-items-center">
                <i class="ti ti-users text-white me-1 fs-5"></i>Upload File
              </a>
            </div>
          </div>
        </div>
        <section>
          <div class="card card-body">
            <div class="table-responsive">
              <table class="table search-table align-middle text-nowrap" id="uploadedFile">
                ...
                <tbody>
                  ...
                  <tr class="search-items">
                    ...
                    <td>12.12.12</td>
                    <td>
                      <button class="btn text-success" style="cursor:default">Approve</button>
                    </td>

                    <td>
                      <a href="file-view.php">
                        <button class="btn  btn-primary me-1 mb-1  btn-sm px-4 fs-4 font-medium">
                          <i class="fa-solid fa-file-pen"></i>
                        </button>
                      </a>
                      <button class="btn btn-danger  me-1 mb-1  btn-sm px-4 fs-4 font-medium" data-bs-toggle="modal"
          ...
          <div class="modal fade" id="openModal" tabindex="-1" aria-labelledby="mySmallModalLabel"
            ...
            <div class="modal-dialog modal-sm">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-dark  font-medium waves-effect" data-bs-dismiss="modal">
                    Close
                  </button>
            ...
            function fetchdata() {
              $.ajax({
                ...
                success: function (response) {
                  ...
                  var table = $('#uploadedFile').DataTable();
